...
/************************* answer questions below this line **************************************************/
1. Explain what a token is used for.

A token is used to help to authorize a user to see protected resources that require authentication.

2. What steps can you take in your web apps to keep your data secure?

Some things you can do to secure a web app is to require login or user name and password along with authorization tokens or secure cookies as well as using security headers. 

3. Describe how web servers work.

Web servers are either a computer or a program that store the code for a website and shares that data when requested on the web.

4. Which HTTP methods can be mapped to the CRUD acronym that we use when interfacing with APIs/Servers.

create, put and post go with create. get goes with read. post goes with update. delete goes with delete.

/************************* questions answered above this line *****************************************************/
